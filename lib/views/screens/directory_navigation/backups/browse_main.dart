...
class BrowseMain extends StatelessWidget {
  static final String _pref = "browse_tab";

  // ViewConfiguration viewConfig;
  Function(Uri) _navigate;

  BrowseMain(this._navigate) : super(key: ValueKey(_pref));

  // void _navigateToBrowseView(BuildContext context, Uri origin) {
  //   this.viewConfig.onFileTap =
  //       (List<NcFile> files, int index) => Navigator.pushNamed(
  //             context,
  //             ImageScreen.route,
